...
export type TechLearn = 'vi-file-type-js-official' | 'vi-file-type-firebase'|'vi-file-type-typescript-official' | 'vi-file-type-html' | 'vi-file-type-css' | 'vi-file-type-css2' | 'vi-file-type-node' | 'vi-file-type-node' | 'vi-file-type-vue'| 'vi-file-type-tailwind' |'vi-file-type-reactjs' |'vi-file-type-angular' 
export enum Icons {
